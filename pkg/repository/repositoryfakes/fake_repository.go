...
type FakeRepository struct {
	...
	GetServiceAccountSecretStub        func(string) (*v1.Secret, error)
...
func (fake *FakeRepository) GetServiceAccountSecret(arg1 string) (*v1.Secret, error) {
	...
	fake.recordInvocation("GetServiceAccountSecret", []interface{}{arg1})
...
func (fake *FakeRepository) GetServiceAccountSecretCalls(stub func(string) (*v1.Secret, error)) {
	fake.getServiceAccountSecretMutex.Lock()
	defer fake.getServiceAccountSecretMutex.Unlock()
	fake.GetServiceAccountSecretStub = stub
}

func (fake *FakeRepository) GetServiceAccountSecretArgsForCall(i int) string {
	fake.getServiceAccountSecretMutex.RLock()
	defer fake.getServiceAccountSecretMutex.RUnlock()
